...
public:
  ...
  void initProgressBar(Adafruit_GFX *gfx, int16_t x, int16_t y, uint16_t w,
					uint16_t h, uint16_t outline, uint16_t fill, uint16_t unfill, uint16_t outline_width);
  void updateProgressBarH(uint8_t progress = 0);
  void updateProgressBarV(uint8_t progress = 0);
  /**********************************************************************/
  /*!
...
private:
  ...
  uint8_t _textsize_x;
  uint8_t _textsize_y;
  uint16_t _outlinecolor, _fillcolor, _textcolor, _unfillcolor;
  char _label[10];
  
  uint16_t _progress;
  uint16_t _outline_width;
