...
// ------------------------------------------------
//<Resources !Start!>
extern "C" const unsigned char image_temp[] PROGMEM;
//<Resources !End!>
...
enum {E_ELEM_IMAGE9,E_ELEM_PROGRESS1,E_ELEM_RINGGAUGE1
      ,E_ELEM_RINGGAUGE2,E_ELEM_TEXT3,E_ELEM_TEXT4};
...
extern gslc_tsElemRef* m_gpsinfo1;
extern gslc_tsElemRef* m_gpsinfo1_4;
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT3,E_PG_MAIN,(gslc_tsRect){90,220,55,26},
    (char*)"RPM",0,E_BUILTIN15X24);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  m_gpsinfo1 = pElemRef;
  
  // Create E_ELEM_TEXT4 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT4,E_PG_MAIN,(gslc_tsRect){310,220,73,26},
    (char*)"Km/h",0,E_BUILTIN15X24);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  m_gpsinfo1_4 = pElemRef;

  // Create progress bar E_ELEM_PROGRESS1 
  pElemRef = gslc_ElemXProgressCreate(&m_gui,E_ELEM_PROGRESS1,E_PG_MAIN,&m_sXBarGauge1,
    (gslc_tsRect){440,90,30,100},0,100,0,GSLC_COL_GREEN,true);
  m_pElemProgress1 = pElemRef;
 
  // Create E_ELEM_IMAGE9 using Image 
  pElemRef = gslc_ElemCreateImg(&m_gui,E_ELEM_IMAGE9,E_PG_MAIN,(gslc_tsRect){440,50,30,30},
    gslc_GetImageFromProg((const unsigned char*)image_temp,GSLC_IMGREF_FMT_RAW1));
